    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Assignment')),
            ],
        ),
        migrations.CreateModel(
            name='GraderModule',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('programming_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.ProgrammingClass')),
            ],
        ),
        migrations.AddField(
            model_name='grade',
        ...
        migrations.AddField(
            ...
            name='grader',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.GraderModule'),
        ),
        migrations.AddField(
            model_name='assignment',
            name='programming_class',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.ProgrammingClass'),
        ),
    ]
