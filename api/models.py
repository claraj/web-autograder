...
class Grade(models.Model):
    ...
    assignment = models.ForeignKey(Assignment, on_delete=models.PROTECT, blank=True, null=False)
    student = models.ForeignKey(Student, on_delete=models.PROTECT, blank=True, null=False)
